                        ...
                        <div className='space-y-4'>
                            <div>
                                ...
                                <p className='text-sm opacity-70'>
                                    Join Zentro and start connecting with others today!
                                </p>
                            </div> 
                                ...
                                <div className='form-control w-full'>
                                    <label className='label cursor-pointer justify-start gap-2'>
                                        ...
                                        <span className='text-xs leading-tight'>I agree to the {" "}
                                            ...
                                            and {" "} 
                                            <span className='text-primary hover:underline'>privacy policy    
                                            </span>
                                        </span>
                                    </label>
                                </div>
                ...
                <div className='max-w-md p-8'>
                    ...
                    <div className='text-center space-y-3 mt-6'>
                        ...
                        <p className='opacity-70'>
                            Practice conversations, make friends, and improve your language skills together on Zentro! 
                        </p>
                    </div>
                </div>
