...
import { BellIcon, UserCheckIcon, MessageSquareIcon, ClockIcon  } from "lucide-react"; 
                      ...
                      <div key={req.id} className="card bg-base-200 shadow-sm hover:shadow-md transition-shadow"> 
                        <div className="card-body p-4">
                          <div className="flex items-center justify-between">
                            ...
                            <button className="btn btn-primary btn-sm" onClick={() => acceptRequestMutation(req._id)}
                              disabled={isPending}
                            >
                              Accept
                            </button>
                      ...
                      <div className="card-body p-4">
                          ...
                          <div className="flex items-start gap-3">
                            ...
                            <div className="flex-1">
                              <h3 className="font-semibold">{notification.recipient.fullName} accepted your friend request</h3>
